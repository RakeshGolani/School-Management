...
/**
 * Ultra-Clean Skeleton Loader for Parent Portal Sidebar
 */
export default function ParentSidebarSkeleton() {
  return (
    <aside className="w-72 bg-white flex flex-col justify-between shadow-lg shadow-slate-200/50 h-screen shrink-0 animate-pulse border-r border-slate-100">
      ...
      <div className="p-5 border-b border-slate-100 space-y-3">
        ...
        {/* Active Ward Card Skeleton */}
        <div className="pt-1 space-y-1.5">
          <div className="flex items-center justify-between px-1">
            <div className="h-2.5 w-16 bg-slate-200 rounded" />
            <div className="h-3 w-12 bg-slate-100 rounded-full" />
          </div>
          <div className="w-full p-2.5 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-between gap-2.5">
            ...
            <div className="w-5 h-5 rounded-lg bg-slate-100 shrink-0" />
          </div>
        </div>
      </div>

      {/* Navigation Menu Links Skeleton */}
      ...
      {/* Bottom Parent Profile Card Skeleton */}
