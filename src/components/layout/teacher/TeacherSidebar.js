  ...
  return (
    ...
    >
      ...
      <div className="p-5 border-b border-slate-200/80 space-y-3">
        ...
        <div className="px-3 py-1.5 rounded-xl bg-primary-50 border border-primary-100 flex items-center justify-between">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-[11px] font-bold text-primary-700 uppercase tracking-wider">Teacher Desk</span>
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-1.5">
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            <GraduationCap size={17} className={pathname === '/teacher/profile' ? 'text-white' : 'text-slate-400 group-hover:text-primary-600 transition-colors'} />
            <span className="truncate">My Profile & ID Card</span>
          </div>
          {pathname === '/teacher/profile' && <ChevronRight size={14} className="text-primary-100" />}
        </Link>
      </div>
