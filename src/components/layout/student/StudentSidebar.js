      ...
      <div className="p-5 border-b border-slate-100 space-y-3">
        ...
        <div className="px-3 py-2 rounded-2xl bg-gradient-to-r from-primary-50 via-primary-50/60 to-white flex items-center justify-between shadow-2xs">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-[11px] font-extrabold text-primary-800 uppercase tracking-wider">Student Desk</span>
          </div>
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            <div className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition-all ${
              ...
              <GraduationCap size={16} strokeWidth={pathname === '/student/profile' ? 2.5 : 2} />
            </div>
            <span className="truncate tracking-tight">Student Profile & ID</span>
          </div>
      ...
      <div className="p-4 border-t border-slate-100 space-y-2.5">
        <div className="p-3 rounded-2xl bg-slate-50 flex items-center justify-between shadow-2xs">
          <div className="flex items-center space-x-3 min-w-0">
            <div className="w-10 h-10 rounded-xl bg-primary-50 border border-primary-500/20 flex items-center justify-center text-primary-700 font-black text-sm shrink-0 overflow-hidden relative shadow-2xs">
              <span>{(studentName || 'S').trim().charAt(0).toUpperCase()}</span>
              {studentPhoto && (studentPhoto.startsWith('/') || studentPhoto.startsWith('http')) ? (
                <img 
                  src={studentPhoto} 
                  alt="" 
