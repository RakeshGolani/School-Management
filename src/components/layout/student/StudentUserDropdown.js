      ...
      >
        ...
        <div className="hidden sm:block text-left pr-1">
          ...
          <div className="flex items-center gap-1.5 mt-0.5">
            ...
            <span className="text-[9px] text-emerald-600 font-bold">• {className}</span>
          </div>
        </div>
        ...
        <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-200 p-3.5 rounded-2xl space-y-3 shadow-2xl z-[100] animate-fadeIn">
          ...
          <div className="flex items-center space-x-3 border-b border-slate-100 pb-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[11px] font-mono text-primary-600 font-bold truncate">Adm: {admissionNumber}</p>
          ...
          <div className="space-y-1 text-xs">
            ...
            >
              ...
              <span>Digital Student Card</span>
            </Link>
